...
output policyConfigHealthModelResourceIds array = [for (deployment, index) in deployments: workloadDeployments[index].outputs.policyConfigHealthModelResourceId]
